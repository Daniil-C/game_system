...
root = tk.Tk()
F = tk.Frame(borderwidth = 2, relief ="ridge", cursor = "dot", height = 1080, width = 1920, master = root)
...
# Play_button.bind("<Button-1>", fun)
Play_button.grid(sticky = "NEWS", column = 1, row = 2)

Exit_button = tk.Button(F, text = "Exit", command = root.quit)
